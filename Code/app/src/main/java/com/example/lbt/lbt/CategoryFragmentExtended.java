...
public class CategoryFragmentExtended extends Fragment {
    private static final String TAG = "CategoryFragmentExtended";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        final View view = inflater.inflate(R.layout.category_fragment_extended, container, false);
